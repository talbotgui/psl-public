...
import { FmkNavigationComponent } from '../../../framework/src/lib/morceaudepage/conteneurPages/page/navigation/fmk.navigation';
...
import { AppEditeurComponent } from './editeur/app.editeur';
...
@Component({
    ...
    standalone: true,
    imports: [FmkEnteteComponent, FmkConteneurPagesComponent, AppEditeurComponent, FmkNavigationComponent, FmkPiedDePageComponent, AsyncPipe]
})
export class AppComponent extends FmkApplicationAbstraitComponent {
    ...
    public override ngOnInit(): void {
        ...
        // En plus des démarches classiques, cette application écoute les changements de configuration
        // La souscription n'est pas à détruire car le composant APP reste actif jusqu'à la fin de vie de l'application
        this.contexteService.obtenirUnObservableDeChargementDeLaConfiguration().subscribe(conf => this.configuration = conf);
    }
}
