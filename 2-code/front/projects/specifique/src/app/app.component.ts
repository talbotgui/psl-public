...
import { PageJccComponent } from './pagejcc/pagejcc.component';
...
@Component({
  ...
  standalone: true,
  imports: [FmkEnteteComponent, FmkConteneurPagesComponent, PageJccComponent, FmkNavigationComponent, FmkPiedDePageComponent, AsyncPipe]
})
