...
@Component({
    selector: 'div[data-fmk-contenudate]', templateUrl: './fmk.contenudate.html', encapsulation: ViewEncapsulation.None,
    standalone: true,
    imports: [ReactiveFormsModule, FmkMessagesValidationComponent, LibelleDirective, i18nPipeDirective]
})
export class FmkContenuDateComponent extends FmkContenuMonoSaisieAbstraitComponent { }
