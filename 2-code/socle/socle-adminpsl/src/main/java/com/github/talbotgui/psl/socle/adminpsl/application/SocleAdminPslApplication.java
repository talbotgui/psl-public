 ...
 */
package com.github.talbotgui.psl.socle.adminpsl.application;
 ...
 */
@SpringBootApplication(scanBasePackages = { "com.github.talbotgui.psl.socle.adminpsl", "com.github.talbotgui.psl.socle.commun" })
...
@EnableFeignClients(basePackages = { "com.github.talbotgui.psl.socle.soumission.apiclient.api" })
public class SocleAdminPslApplication {
	...
	public static void main(String[] args) {
		SpringApplication springApplication = new SpringApplication(SocleAdminPslApplication.class);
