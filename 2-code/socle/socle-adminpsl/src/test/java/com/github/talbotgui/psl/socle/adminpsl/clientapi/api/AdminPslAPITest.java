...
import com.github.talbotgui.psl.socle.adminpsl.controleur.AbstractAdminPslControleurTest;
...
class AdminPslAPITest extends AbstractAdminPslControleurTest {
	...
	/** API à tester */
	@Autowired
	void setApi(AdminPslAPIForTest api) {
