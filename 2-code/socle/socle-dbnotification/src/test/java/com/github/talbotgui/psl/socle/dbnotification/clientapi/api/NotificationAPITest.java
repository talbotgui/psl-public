...
import com.github.talbotgui.psl.socle.dbnotification.controleur.AbstractNotificationControleurTest;
...
class NotificationAPITest extends AbstractNotificationControleurTest {
	...
	/** API à tester */
	@Autowired
	void setApi(NotificationAPI api) {
