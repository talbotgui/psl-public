...
public class RegionActuelleDto implements ITransformableEnDocumentLuceneDto {
	...
	public RegionActuelleDto() {
		super();
	}

	public RegionActuelleDto(String codeInsee, String libelle, String codeInseeCommuneChefLieu) {
		super();
	...
	public String toJson() {
		return "{\"libelle\":\"" + this.libelle + "\", \"codeInsee\":\"" + this.codeInsee + "\", \"communeChefLieu\":"
				+ this.communeChefLieu.toJsonSimple() + "}";
	}
