...
public interface ReferentielService {
	...
	List<CommuneNaissanceDto> rechercherCommuneNaissance(String chaine);

	List<CommuneActuelleDto> rechercherCommunesActuelles(String chaine);

	List<CommuneUgleDto> rechercherCommuneUgle(String chaine);

	List<DepartementActuelDto> rechercherDepartementsActuels(String chaine);

	List<PaysActuelDto> rechercherNationalitesDePaysActuel(String chaine);

	List<PaysActuelDto> rechercherPaysActuels(String chaine);

	List<PaysNaissanceDto> rechercherPaysNaissance(String chaine);

	List<RegionActuelleDto> rechercherRegionsActuelles(String chaine);
