...
import com.github.talbotgui.psl.socle.referentiel.controleur.AbstractReferentielControleurTest;
...
class ReferentielAPITest extends AbstractReferentielControleurTest {
	...
	/** API à tester */
	@Autowired
	void setApi(ReferentielAPIForTest api) {
