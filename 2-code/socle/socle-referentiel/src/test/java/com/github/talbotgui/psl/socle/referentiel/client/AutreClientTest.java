...
class AutreClientTest extends AbstractTest {

	@Autowired
	private AutreClient client;

	@Test
	void testPaysEtANationalites() {
		//
		//
		Map<String, PaysEtNationaliteDto> codes = this.client.telechargerReferentielPaysEtANationalites();
		//
		Assertions.assertNotNull(codes);
		Assertions.assertTrue(codes.size() > 240);
	}
