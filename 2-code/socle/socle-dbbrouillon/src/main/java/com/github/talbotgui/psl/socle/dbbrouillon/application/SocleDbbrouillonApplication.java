 ...
 */
@SpringBootApplication(scanBasePackages = { "com.github.talbotgui.psl.socle.dbbrouillon", "com.github.talbotgui.psl.socle.commun" })
...
@EnableFeignClients(basePackages = { "com.github.talbotgui.psl.socle.dbconfiguration.apiclient.api", "com.github.talbotgui.psl.socle.dbnotification.apiclient.api" })
public class SocleDbbrouillonApplication {
	...
	public static void main(String[] args) {
		SpringApplication springApplication = new SpringApplication(SocleDbbrouillonApplication.class);
