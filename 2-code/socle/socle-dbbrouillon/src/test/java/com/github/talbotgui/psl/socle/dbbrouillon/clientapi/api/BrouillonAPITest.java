 ...
 */
package com.github.talbotgui.psl.socle.dbbrouillon.clientapi.api;
...
import com.github.talbotgui.psl.socle.dbbrouillon.controleur.AbstractBrouillonControleurTest;
import com.googlecode.catchexception.CatchException;

import feign.FeignException;

/** Classe de test spécifique au client Feign se basant sur les cas de test décrits dans la classe AbstractBrouillonExterneControleurTest */
// Test d'API Feign
...
class BrouillonAPITest extends AbstractBrouillonControleurTest {
	...
	/** API à tester */
	@Autowired
	void setApi(BrouillonAPIForTest api) {
