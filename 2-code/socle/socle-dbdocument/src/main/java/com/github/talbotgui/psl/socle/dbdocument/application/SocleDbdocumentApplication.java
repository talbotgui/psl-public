 ...
 */
package com.github.talbotgui.psl.socle.dbdocument.application;
 ...
 */
@SpringBootApplication(scanBasePackages = { "com.github.talbotgui.psl.socle.dbdocument", "com.github.talbotgui.psl.socle.commun" })
...
@EnableFeignClients(basePackages = { "com.github.talbotgui.psl.socle.dbconfiguration.apiclient.api" })
public class SocleDbdocumentApplication {
	...
	public static void main(String[] args) {
		SpringApplication springApplication = new SpringApplication(SocleDbdocumentApplication.class);
