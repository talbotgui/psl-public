...
public interface TransfertDao {
	...
	/**
	 * Modification du statut d'un document de transfert.
	 * 
	 * @param idDocumentTransfert ID du document de transfert.
	 * @param statut              Statut à mettre.
	 */
	void modifierEtatDuTransfert(String idDocumentTransfert, StatutDocumentTransfert statut);

	/**
	 * Recherche d'un document généré ou d'une pièce jointe par son ID.
	 * 
	 * @param idDocument ID du document ou de la pièce jointe.
	 * @return
	 */
