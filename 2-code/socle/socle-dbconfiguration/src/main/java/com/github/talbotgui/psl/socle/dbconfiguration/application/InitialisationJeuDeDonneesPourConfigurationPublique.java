 ...
 */
@Component
public class InitialisationJeuDeDonneesPourConfigurationPublique extends AbstractInitialisationJeuDeDonnees {

	/** Début du nom des fichiers de brouillon dans les assets des projets Front Angular */
	private static final String PREFIX_FICHIER_CONFIGURATION_PUBLIQUE_DANS_ASSETS_ANGULAR = "param";

	@Override
	protected String getNomCollectionMongoDB() {
		return AbstractMongoDao.COLLECTION_MONGODB_POUR_CONFIGURATION_PUBLIQUE;
	}
	...
	protected void initialiserJeuDeDonnees() throws IOException {
		...
		InitialisationMongoDBUtils.insererDocumentsDepuisLesFichiersDeBouchonDesProjetsFront(this.clientMongo, super.baseDeDonneeMongoDB,
				this.getNomCollectionMongoDB(), PREFIX_FICHIER_CONFIGURATION_PUBLIQUE_DANS_ASSETS_ANGULAR);
	}
}
