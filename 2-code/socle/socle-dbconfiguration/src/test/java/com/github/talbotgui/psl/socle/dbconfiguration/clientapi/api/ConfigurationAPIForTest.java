...
@FeignClient(name = "socle-dbconfiguration", contextId = "ConfigurationAPI", url = "http://localhost:${server.port}")
interface ConfigurationAPIForTest extends ConfigurationAPI {
}